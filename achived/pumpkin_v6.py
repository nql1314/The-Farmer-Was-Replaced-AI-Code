...
# 7x7区域工人（12个）- 左半区4列x7行，右半区3列x7行
# 坐标: (0,0),(8,0),(16,0),(0,8),(0,16),(25,9),(17,25),(25,25),(17,17),(25,17),(9,25),(8,8)
def worker1():
    create_worker_left_7x7(8, 0, 8, 12, 0)
spawn_drone(worker1)
def worker2():
    create_worker_left_7x7(16, 0, 16, 22, 0)
spawn_drone(worker2)
def worker3():
    create_worker_left_7x7(0, 8, 0, 4, 8)
spawn_drone(worker3)
def worker4():
    create_worker_left_7x7(0, 16, 0, 4, 22)
spawn_drone(worker4)
def worker5():
    create_worker_left_7x7(25, 9, 28, 31, 9)
spawn_drone(worker5)
def worker6():
    create_worker_left_7x7(17, 25, 20, 23,31)
spawn_drone(worker6)
def worker7():
    create_worker_left_7x7(25, 25, 28, 31,31)
spawn_drone(worker7)
def worker8():
    create_worker_left_7x7(17, 17, 20, 23,23)
spawn_drone(worker8)
def worker9():
    create_worker_left_7x7(25, 17, 28, 31,23)
spawn_drone(worker9)
def worker10():
    create_worker_left_7x7(9, 25, 9, 13,31)
spawn_drone(worker10)
def worker11():
    create_worker_left_7x7(8, 8, 8, 12, 8)
spawn_drone(worker11)

# 8x8区域工人（4个）- 坐标: (8,16),(16,8),(24,0),(8,8)
def worker12():
    create_worker_left_8x8(0, 24, 0, 4, 31)
spawn_drone(worker12)
def worker13():
    create_worker_left_8x8(8, 16, 8, 12, 23)
spawn_drone(worker13)
def worker14():
    create_worker_left_8x8(16, 8, 19, 23, 8)
spawn_drone(worker14)
def worker15():
    create_worker_left_8x8(24, 0, 27, 31, 0)
