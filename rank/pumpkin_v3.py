...
def create_worker_left(region_x, region_y):
    ...
    def worker():
        create_worker_right(region_x, region_y)
    spawn_drone(worker)
...
def worker1():
    create_worker_left(0, 7)
spawn_drone(worker1)
def worker2():
    create_worker_left(0, 19)
spawn_drone(worker2)
def worker3():
    create_worker_left(0, 26)
spawn_drone(worker3)
def worker4():
    create_worker_left(7, 0)
spawn_drone(worker4)
def worker5():
    create_worker_left(7, 7)
spawn_drone(worker5)
def worker6():
    create_worker_left(7, 19)
spawn_drone(worker6)
def worker7():
    create_worker_left(7, 26)
spawn_drone(worker7)
def worker8():
    create_worker_left(19, 0)
spawn_drone(worker8)
def worker9():
    create_worker_left(19, 7)
spawn_drone(worker9)
def worker10():
    create_worker_left(19, 19)
spawn_drone(worker10)
def worker11():
    create_worker_left(19, 26)
spawn_drone(worker11)
def worker12():
    create_worker_left(26, 0)
spawn_drone(worker12)
def worker13():
    create_worker_left(26, 7)
spawn_drone(worker13)
def worker14():
    create_worker_left(26, 19)
spawn_drone(worker14)
def worker15():
    create_worker_left(26, 26)
spawn_drone(worker15)
quick_print("end create worker",get_tick_count()) #3273
create_worker_left(0, 0)