...
def create_shared():
    return {
        ...
        (0, 7):{'ready':False,'unverified_left':[],"unverified_right":[],"help_flag":False,'type':'6x6'},
        (0, 19):{'ready':False,'unverified_left':[],"unverified_right":[],"help_flag":False,'type':'6x6'},
        (0, 26):{'ready':False,'unverified_left':[],"unverified_right":[],"help_flag":False,'type':'6x6'},
        (7, 0):{'ready':False,'unverified_right':[],"unverified_left":[],"help_flag":False,'type':'6x6'},
        (7, 26):{'ready':False,'unverified_right':[],"unverified_left":[],"help_flag":False,'type':'6x6'},
        (19, 0):{'ready':False,'unverified_right':[],"unverified_left":[],"help_flag":False,'type':'6x6'},
        (19, 26):{'ready':False,'unverified_right':[],"unverified_left":[],"help_flag":False,'type':'6x6'},
        (26, 0):{'ready':False,'unverified_right':[],"unverified_left":[],"help_flag":False,'type':'6x6'},
        (26, 7):{'ready':False,'unverified_right':[],"unverified_left":[],"help_flag":False,'type':'6x6'},
        (26, 19):{'ready':False,'unverified_right':[],"unverified_left":[],"help_flag":False,'type':'6x6'},
        (26, 26):{'ready':False,'unverified_right':[],"unverified_left":[],"help_flag":False,'type':'6x6'},
        # 8x8区域状态（4个中心区域）
        (7, 7):{'ready':False,'unverified_left':[],"unverified_right":[],"help_flag":False,'type':'8x8'},
        (7, 17):{'ready':False,'unverified_left':[],"unverified_right":[],"help_flag":False,'type':'8x8'},
        (17, 7):{'ready':False,'unverified_left':[],"unverified_right":[],"help_flag":False,'type':'8x8'},
        (17, 17):{'ready':False,'unverified_left':[],"unverified_right":[],"help_flag":False,'type':'8x8'},
        "left_active_drones_6x6":  [(0,0),(0,7),(0,19),(0,26),(7,0),(7,26),(19,0),(19,26),(26,0),(26,7),(26,19),(26,26)],
        "right_active_drones_6x6":  [(0,0),(0,7),(0,19),(0,26),(7,0),(7,26),(19,0),(19,26),(26,0),(26,7),(26,19),(26,26)],
        "left_active_drones_8x8":  [(7,7),(7,17),(17,7),(17,17)],
        "right_active_drones_8x8":  [(7,7),(7,17),(17,7),(17,17)]
    }
...
# 6x6区域的worker_left函数
def create_worker_left_6x6(region_x, region_y, start_x_L, start_x_R):
    goto(start_x_L, region_y)
    def worker():
        create_worker_right_6x6(region_x, region_y, start_x_R)
    spawn_drone(worker)
    shared = wait_for(memory_source)
    region_data = shared[(region_x, region_y)]
...
# 8x8区域的worker_left函数
def create_worker_left_8x8(region_x, region_y, start_x_L, start_x_R):
    goto(start_x_L, region_y)
    def worker():
        create_worker_right_8x8(region_x, region_y, start_x_R)
    spawn_drone(worker)
    shared = wait_for(memory_source)
    region_data = shared[(region_x, region_y)]
...
def create_worker_right_6x6(region_x, region_y, start_x):
    shared = wait_for(memory_source)
    region_data = shared[(region_x, region_y)]
    region_x_R = region_x + 3
    goto(start_x, region_y)
...
def create_worker_right_8x8(region_x, region_y, start_x):
    shared = wait_for(memory_source)
    region_data = shared[(region_x, region_y)]
    region_x_R = region_x + 4
    goto(start_x, region_y)
...
# 6x6区域工人（12个边缘区域）
def worker1():
    create_worker_left_6x6(0, 7, 0, 3)
spawn_drone(worker1)
def worker2():
    create_worker_left_6x6(0, 19, 0, 3)
spawn_drone(worker2)
def worker3():
    create_worker_left_6x6(0, 26, 0, 3)
spawn_drone(worker3)
def worker4():
    create_worker_left_6x6(7, 0, 7, 10)
spawn_drone(worker4)
def worker5():
    create_worker_left_6x6(7, 26, 7, 10)
spawn_drone(worker5)
def worker6():
    create_worker_left_6x6(19, 0, 21, 24)
spawn_drone(worker6)
def worker7():
    create_worker_left_6x6(19, 26, 21, 24)
spawn_drone(worker7)
def worker8():
    create_worker_left_6x6(26, 0, 28, 31)
spawn_drone(worker8)
def worker9():
    create_worker_left_6x6(26, 7, 28, 31)
spawn_drone(worker9)
def worker10():
    create_worker_left_6x6(26, 19, 28, 31)
spawn_drone(worker10)
def worker11():
    create_worker_left_6x6(26, 26, 28, 31)
spawn_drone(worker11)

# 8x8区域工人（4个中心区域）
def worker12():
    create_worker_left_8x8(7, 7, 7, 11)
spawn_drone(worker12)
def worker13():
    create_worker_left_8x8(7, 17, 7, 11)
spawn_drone(worker13)
def worker14():
    create_worker_left_8x8(17, 7, 17, 21)
spawn_drone(worker14)
def worker15():
    create_worker_left_8x8(17, 17, 17, 21)
spawn_drone(worker15)

create_worker_left_6x6(0, 0, 0, 3)
while True:
